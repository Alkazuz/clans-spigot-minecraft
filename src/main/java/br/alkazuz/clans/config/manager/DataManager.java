...
public class DataManager {
	...
	public static void createFolder(String folder) {
		try {
			File pasta = new File(Clans.getInstance().getDataFolder() + File.separator + folder);
			if (!pasta.exists()) {
				pasta.mkdirs();
			}
		} catch (Throwable e) {
	...
	public static File getFolder(String folder) {
		File Arquivo = new File(Clans.getInstance().getDataFolder() + File.separator + folder);
		return Arquivo;
	}

	public static File getFile(String file, String folder) {
		File Arquivo = new File(Clans.getInstance().getDataFolder() + File.separator + folder, file + ".yml");
		return Arquivo;
	}
